...
tf.app.flags.DEFINE_string('train_spec_dir', '', 'Training spectograms data directory.')
tf.app.flags.DEFINE_string('val_spec_dir', '', 'Validation spectograms data directory.')
tf.app.flags.DEFINE_string('test_spec_dir', '', 'Testing spectograms data directory.')
...
tf.app.flags.DEFINE_integer('summary_step', 10, 'Number of steps we cycle through before saving summary.')
